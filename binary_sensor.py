"""Support for Ecowitt Weather Station binary sensors."""
...
from . import EcowittWeatherEntity
...
@dataclass
class EcowittBinarySensorDescription(
    BinarySensorEntityDescription, EcowittBinarySensorDescriptionMixin
):
...
async def async_setup_entry(
    ...
    async_add_entities(
        [
            EcowittWeatherBinarySensor(
                ecowitt, mac_address, station[ATTR_NAME], description
            )
            for mac_address, station in ecowitt.stations.items()
...
class EcowittWeatherBinarySensor(EcowittWeatherEntity, BinarySensorEntity):
    """Define Ecowitt binary sensor."""
