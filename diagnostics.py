"""Diagnostics support for Ecowitt."""
...
async def async_get_config_entry_diagnostics(
    ...
    ecowitt: EcowittStation = hass.data[DOMAIN][entry.entry_id]
    ...
    return {
        ...
        "stations": async_redact_data(ecowitt.stations, TO_REDACT),
    }