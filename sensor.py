"""Support for Ecowitt Weather Station sensors."""
...
from . import EcowittStation, EcowittWeatherEntity
...
async def async_setup_entry(
    ...
    """Set up Ecowitt sensors based on a config entry."""
    ecowitt = hass.data[DOMAIN][entry.entry_id]

    async_add_entities(
        [
            EcowittWeatherSensor(ecowitt, mac_address, station[ATTR_NAME], description)
...
class EcowittSensor(EcowittWeatherEntity, SensorEntity):
    ...
    def __init__(
        ...
        super().__init__(ecowitt, mac_address, station_name, description)
    ...
    def update_from_latest_data(self) -> None:
        ...
        raw = self._ecowitt.stations[self._mac_address][ATTR_LAST_DATA][
